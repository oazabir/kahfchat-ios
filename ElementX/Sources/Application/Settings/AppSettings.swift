...
final class AppSettings {
    ...
    private(set) var accountProviders = ["kahf.co.uk"]
    ...
    private(set) var websiteURL: URL = "https://kahf.co.uk/"
    /// A URL that contains the app's logo that may be used when showing content in a web view.
    private(set) var logoURL: URL = "https://kahf.co.uk/mobile-icon.png"
    /// A URL that contains that app's copyright notice.
    private(set) var copyrightURL: URL = "https://kahf.co.uk/copyright"
    /// A URL that contains the app's Terms of use.
    private(set) var acceptableUseURL: URL = "https://kahf.co.uk/acceptable-use-policy-terms"
    /// A URL that contains the app's Privacy Policy.
    private(set) var privacyURL: URL = "https://kahf.co.uk/privacy"
...
//     private(set) var oidcRedirectURL: URL = "https://element.io/oidc/login"
    private(set) var oidcRedirectURL: URL = "https://kahf.co.uk/oidc/login"
